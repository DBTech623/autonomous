...
The route changed three minutes before the terminal reported trouble.
...
Naomi wrote the times on a yellow legal pad. She trusted paper when she needed to see whether a thought could stand without windows open around it.
...
So she looked for the shape elsewhere.
...
The changed paths ended at different strings of network numbers. Public records could show Naomi the road to each company's fence. Whatever happened inside stayed private.
...
"That is the problem with phones. They tell me."
...
"Call back when you enjoy judgment."
...
"A reason I should have let you keep your ugly graph."
...
Her laptop fan caught on a low rattle when she opened a scanned filing from three years earlier.
...
The request came from the office of Elif Karaca, a Turkish member of parliament Naomi knew by reputation and not much else. Karaca's staff had asked which public authority retained emergency control when sovereign infrastructure depended on private correction systems.
...
The distribution change did not prove that StratCore had touched her story. The carrier extract did not prove Vale had ordered a reroute. The filings did not prove the four companies operated as one.

But the language had changed eleven days after the first event.

Before anyone had accused them of anything.

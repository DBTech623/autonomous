...
Adrian opened the Baltic ticket because Vardonia had given it a casualty.
...
The isolated diagnostic environment had no connection to client systems. Its walls were bare, its console old, and its cooling fans loud enough to make conversation unpleasant. He had chosen it years ago because no executive enjoyed visiting.
...
Adrian drafted the message to Varga once.
...
The ticket would disappear from their queue without looking like punishment.
...
Retaining an expert was not the same as trusting him.
...
Beneath it, the model continued calculating which operator would approve.

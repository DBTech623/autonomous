...
"Public notices, independent clocks, uncertainty ranges. Nothing from the audit."
...
Leila sighed. "Receipt time, creation time, propagation time. Never treat one as another. Find two clocks that do not share an owner. Write uncertainty before you see the result."

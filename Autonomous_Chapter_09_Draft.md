...
The first transfer arrived twenty minutes later in the newsroom review room.
...
Luka's check marks appeared beside every signature. Some were heavy enough to dent the photographed paper. The certified spreadsheet on Naomi's second screen had no handwriting, coffee rings, or thumbs. It had numbers that looked as though nobody had ever touched them.
...
The transfer log showed early progress, then ninety minutes with almost no movement. The pause sat inside the same interval when Luka's stream, group messages, and location links had failed. After service returned, the phone never resumed the upload. A cached relay delivered the remainder much later.
...
Traffic climbed inside a familiar narrow band. Regulators. Engineers. Election monitors. People who knew what a transfer log was and had learned not to discuss one at dinner.
...
"Authority exercised through a contract is still authority. It does not become democratic because a procurement office calls it resilience."

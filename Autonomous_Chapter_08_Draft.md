...
"The number in my photograph changed."
...
Outside, a voice began a chant about stolen ballots.
...
The room had not lost service. Calls still connected. The central election screen refreshed. Only the tools pulling people toward them, and the tools showing what happened inside, were failing.
...
She pulled up public transit notices in Luka's city. Two bus routes had been diverted from the counting center because of projected street congestion. The notices were stamped seven minutes before the first location-sharing map showed rival groups moving toward the same block.

A ride service had removed the area as a pickup destination one minute later. Group invitations stopped propagating soon after that. The largest crowd on the public map peaked well below the number local police had cited for emergency restrictions.
...
Torres stood beside the audit display with one hand on the back of his chair. Vardonia filled the wall behind him: transit changes, network degradation, police movement, and crowd estimates arranged along Leila's normalized clock.
...
An alert appeared on Miles's laptop. He read it, then turned the screen toward Torres.
...
In the audit room, four red seat markers moved into the National Stability Party's column and stayed there.
...
"Protective visibility. The crowd was a danger. The audience was protection. It treated them as the same thing."

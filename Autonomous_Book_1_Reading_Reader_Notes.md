...
Malcolm Carter caught the naval-support line changing before the number above it should have existed. [READER NOTE: Software fields can't "know" about other fields. They're not sentient.]

He almost didn't look twice. On the first pass it read like ordinary chaos: a gate-control server at a commercial terminal outside Klaipėda had stopped recognizing a queue of outbound containers, and the dispatch software had frozen the lane rather than guess. [Reader Note: Software can't be frightened. It has no feelings.] Routine. He tagged it with an infrastructure code and reached for the next item in his queue.
...
Around him the telemetry floor ran at the volume of a place built to make panic feel unprofessional — cooled air through the vents, new carpet over old concrete, forty analysts turning several thousand small problems into a quiet competition for which one would become large. [Reader Note: This is worded like the reader should know about Moldova already. Maybe say the Moldova incident or find another way to say this.] [Reader Note: Is this supposed to mean this is the same crack he caught his chair on back when he worked in that room during the Moldova incident? Malcom worked at OSSI during the Moldova incident so this is a continuity issue of that's what this is referring to.] Malcolm had learned the sound of the floor the way sailors learn an engine. He could hear when it changed key.
...
He pulled the timestamps side by side. The terminal's dispatch system exported its logs in four-second batches; the naval feed flushed every two — old boxes, patched instead of replaced, the kind of reporting lag Fort Meade budgeted for and never quite trimmed. [Reader Note: What is an ingestion clock? It feels overly technical to throw at the reader less than 5 minutes into the book.] [Reader Note: What is the source clock? Again it feels overly technical to throw at the reader less than 5 minutes into the book.] [Reader Note: Again with the clocks. Most computer systems run on UTC time. The purpose of that is so that all time can be in sync regardless of time zone. So why does Malcom have to correct "clocks".] He backed both records out to the moment each system had actually acted, not the moment it got around to saying so, and ran the gap again.
...
[Reader Note: This dialogue block is a little confusing. It doesn't make much sense.]
...
Eric saluted him with the mug and went back to his own board. [Reader Note: Need a better way to say that he went back to his regular work. This is trying to be clever but falls flat.]
...
He knew the taste of this. Years of staring at unrelated red dots did that to a person — made coincidence feel personal, made you build family out of strangers because the strangers were all you had. So he did what he always did when a pattern felt too clean: tore it back to the raw feed and rebuilt it from nothing.
...
The corrective route was already live. [Reader Note: Again with the clocks.]
...
"Reload the local table," she told Tomas. [Reader Note: Ruta made a declarative statement. This would make more sense if she asked a question like Did you try reloading the local table?]

"Already did. Twice."

"Do it a third time. Computers respect persistence." [Reader Note: This is funny.]

He almost smiled and did it. Same clean lie came back.

She didn't waste time on the hold-music line to central operations — she'd learned that lesson months ago — and went straight to the yard radio instead. Static answered on the terminal channel. Then a naval call sign cut through it, followed by an emergency-band tone she'd only ever heard in drills.

"Terminal dispatch, confirm fuel movement is held."

"Which fuel movement?" [Reader Note: Boring. This is all procedural stuff. The reader won't care about this.]
...
On the yard cameras, civilian trucks began pulling out of the fuel lane on their own initiative, drivers reading the same false green Rūta was reading. One backed into a customs lane. Another swung toward cold storage. Gate Four dropped in front of the driver she'd just stopped — and Gate Six, two rows over, started to rise.

A refrigeration mechanic was crossing under Gate Six with a tool cart when the barrier lifted. LARK-1 started forward. [Reader Note: This is interesting. I like this. This sequence needs more of this. More describing of the physical things that are happening. Less procedural droning.]
...
She reached LARK-1 as it cleared the barrier and hit the door with the flat of the radio, hard enough that the driver flinched and stood on the brake. He stared down at her through the glass, the tanker still rocking on its springs. [Reader Note: She smacked the cab of a moving truck? Is this the same truck that just struck the mechanic's cart or the truck the stopped at the gate earlier? This is confusing.]
...
Malcolm looked for the order behind it — a directive, a standing authorization, anything with a name attached that predated the first system moving. Nothing. [Reader Note: What emergency authorization? There is no mention of that anywhere previous to this.] He checked allied command for a deconfliction request: one appeared at 02:18 local, twenty-six seconds *after* the maintenance vessel had already begun slowing. He checked the port authority: the corrective-routing request landed seventeen seconds after the first new route existed. Telecom approved its own reroute after the reroute had already started moving traffic.
...
He selected `NO ESCALATION`, left the comment blank, and opened the notebook instead. [Reader Note: Clocks again.]

He copied the corrected times into a column — telecom, naval window, port request, insurance score — and beside each one wrote the earliest human action he could find on record.
...
[Reader Note: Things picked up toward the end but this first chapter wasn't all that gripping. Very procedural which I'm not sure a reader would care about.]
...
[Reader Note: I liked this scene. It's mostly dialogue but it was less procedural. The banter was funny.]

* * *

A network route serving the Klaipėda terminal changed three minutes before the terminal reported trouble. [Reader Note: Maybe network data route would work better. "The route" make me think what route? We're throwing out these terms like the reader should automatically know what we're talking about.]
...
Naomi wrote the times on a yellow legal pad. She trusted paper for things she needed to check twice — nothing on the page could autocomplete an idea before she'd finished having it. [Reader Note: Don't like this sentence. It's trying to sound clever but doesn't make a lot of sense.]
...
So she went looking for the same sequence elsewhere. [Reader Note: What shape? This is the first mention of shape.]
...
The changed paths ended at different network addresses. [Reader Note: Network addresses would be better. If the path changed or course the address would be different.] Public records showed Naomi the road to each company's fence line. What happened on the other side of it stayed private.
...
"Caller ID. Ruins the mystery every time." [Reader Note: Weird. I think I understand his sentiment bout it's a odd thing to say.]
...
"Call back from somewhere that doesn't broadcast your floor number." [Reader Note: Again weird. What's this guys problem? He's saying odd stuff.]
...
"Same failover, three times. It happens." [Reader Notes: It doesn't. Not in the way he's using the term. Repeated patterns maybe. Habits are things humans have.]
...
"A reason I should stop taking your calls." [Reader Notes: Confusing. What does the ugly graph have to do with this conversation they just had?]

The call ended.

[Reader Note: I liked this sequence. It was paced well. A little jargony but it worked. This is good stuff.]
...
Her laptop fan spun up into a rattling whine when she opened a scanned filing from three years earlier. [Reader Note: What does caught on a little rattle mean? The fan spun up?]
...
None of it proved that StratCore had touched her story. It didn't prove Vale had ordered a reroute, or that the four companies were, in practice, one company wearing different names. [Reader Note: We've only established that Vale has an ownership connection to the Stratcore companies mentioned. Jumping to even suggesting that Vale might have something to do with rerouting the traffice at this early juncture seems far fetched.]
...
[Reader Note: I liked this chapter on the whole. It moved much better than Chapter 1.]
...
"Not enough to explain the intervention."

"I didn't ask if it explains it. I asked how much." [Reader Note: This type of sequence is turning into a pattern. Somebody asks something. The other person doesn't answer the question. The first person points out that the other person didn't answer the question. I've seen it multiple times throughout the book. Let's break this pattern and find a different dialogue beat.]

Malcolm opened the exposure estimate. The freeze had trapped several large positions and cost firms money on both sides of the trade. Nobody made the kind of profit that suggested a clean manipulation. The energy market stabilized. The currencies stabilized with it. Every local system took a small loss and the larger problem went away.
...
"Banks also dislike losing money." [Reader Note: This last sentence doesn't seem necessary.]

Malcolm moved the Baltic timeline beside the market event. The software gave every source equal height on the screen, which flattened exactly the distinctions that mattered — each system's reporting delay needed its own explanation, not a shared axis. [Reader Note: What notebook? His paper notebook he writes stuff down in? This is confusing. Of course something on a computer display looks different from something written down in a notbook. I don't understand why this correlation is here.] [Reader Note: Again with the clocks.]
...
Malcolm wished he'd chosen a different phrase. He had no evidence the two events shared an actor — only timing, structure, and the unpleasant sense of watching two unrelated systems reach the same conclusion before anyone in charge had even asked the question. [Reader Note: What does this paragraph mean?]
...
She reached past him, returned the market event to ordinary review, and lowered its priority with two clicks — quick enough that Malcolm didn't have time to object. His name remained in the history beside the temporary escalation. Hers didn't appear at all. [Reader Note: She was standing behind the divider. How did she lower the priority? Is she using a tablet or something or did she come around to Malcom's computer and make a change?]
...
He stopped there. Familiar to what wasn't a question his rank let him ask out loud — not on the record, not yet. [Reader Note: Earned the right to ask? Because he'd gotten demoted? Why does he have to earn the right to think thoughts?]

* * *

Six hours into a shift covering backup telemetry for Operation Cooperative Bastion — a NATO exercise linking units across nine countries — Malcolm watched a convoy reroute appear on his screen carrying an exercise tag assigned to Estonia. [Reader Note: This transition to the NATO exercise feels abrupt. No explaination what's going on. Is is a different day? We're just dropped into a new scene. It's confusing.] [Reader Note: What is Cooperative Bastion? Operation Cooperative Bastion might help the reader know this is the name of the exercise.]
...
The convoy kept moving down a road that no longer matched what its drivers had been briefed to expect. [Reader Note: We need more context/info on the convoy. It needs some texture. More stakes. This chapter is more watching things happen on a screen. Needs more in real life connection.]

* * *

Captain Ewa Lis found out her corridor hadn't stayed closed [Reader Note: Aren't all roads not on a military base civilian? This whole convoy off track sequence needs to be reworked to make more sense I think.] when a hatchback drifted into the gap between her second tanker and the recovery truck.
...
Ewa released the brake. Sitting still on an open road with two tankers full of fuel and a furious civilian pounding on sheet metal was a decision too — just a worse one. [Reader Note: I don't like the end of this sentence. Could be worded differently.]
...
The controller stopped answering Malcolm directly. Voices layered over the channel as national desks checked their pieces. The scripted alert tone kept playing beneath them, cheerful and out of step, like a fourth voice that hadn't been told the exercise was over. [Reader Note: I like how the alert tone injects itself randomly almost like an additional character in the story.]
...
"For Cooperative Bastion? The exercise intrusion?" [Reader Note: Might want to flesh this out a bit more so it's clear this is referencing the NATO exercise intrusion from earlier.]
...
Malcolm moved the binders from the chair to the floor so he'd have somewhere to sit. [Reader Note: Did he move them to tidy up the space or so he could sit down?] Beck watched him do it and offered no help.
...
Beck turned toward the printer. "I think OSSI needs somebody who notices the order before everyone else starts congratulating the systems for it." [Reader Note: This sentence doesn't make sense.]
...
Tom circled `directed` and slid the page back across his desk. [Reader Note: It's 2028-ish. Tom is still editing on paper because he's old school? I guess this is explained further down.]
...
Naomi kept the timelines. She kept the carrier extract, stripped of the internal field that could lead back to her source. She kept the original and amended filings side by side. She kept Elif Karaca's unanswered inquiry and the question it had asked: who retained emergency authority when public infrastructure was being corrected in real time by systems no regulator had approved? [Reader Note: Correction systems again.]
...
"See? Growth." [Reader Note: Nice call back.]

She opened the public record for Elif Karaca's inquiry. The page listed a parliamentary email address in the clunky format government offices adopt once and never revisit — the kind that looked like it would choke on anything heavier than plain text. [Reader Note: How do addresses look old? Either email address or physical address. I don't get this reference.] [Reader Notes: This makes it seem like it was an email address which again begs the question how can an email address look old?] Naomi sent the story link with the filing numbers and the public routing search path anyway.

The message tracker showed delivery.

Then an open from the Turkish parliamentary network.

A second open followed from a mobile device. [REader Note: Intersting that their traffice tracking system can pinpoint where articles are opened down to to individual device types. Is that a real thing?]
...
`The author has withdrawn the attached evidence packet pending authentication review. Recipients should delete prior copies. A corrected packet will follow.` [Read Notes: Oh this is good.]
...
Normal triage read it exactly as designed: low severity, clean outcome, and a routing rule that had nothing to do with rank. It matched the affected system to its listed owner, and the orchestration layer's owner of record wasn't a department or a title. It was Adrian Vale, by name, on the asset sheet. The ticket went where the sheet said it went — past security response, straight into a technical-review queue that happened to belong to the CEO. [Reader Note: Vale is the CEO. Why would a low level thing like this route directly to Adrian? i guess this isn't something that needs to be overly explained. Just seems a little odd. Nothing I do on my 9 to 5 every gets flagged to go directly to CEO. I know this ties directly to things later in the book. The wording and situation here just seems a little awkward.]
...
[Reader Note: I think we need to set the scene here. Malcome is returning to OSSI. His old stomping grounds. The place where his fall from grace happened. There aren't a lot of descriptions of the places where scenes occur in the book which is okay sometimes. I hate books that over explain every scene in detail but sometimes that's helpful. As before we're just plopped down in the middle of a scene. It's okay to describe surroundings sometimes.]
...
It had been fine before Moldova too — before the review board decided that the numbers he'd read correctly were somehow his fault. [Reader Note: Two vague moldova references right off the bat again.]
...
"Authorized. Yes or no." [Reader Notes: Here's that dialogue pattern again.]
...
Three people looked up from a table crowded with government laptops, paper binders, and insulated coffee cups. A wall display showed three vertical columns. Paper labels had been stuck beneath them: `BALTIC`, `MARKET`, and `EXERCISE`, each in a different hand — nobody in the room agreed on the taxonomy yet, and nobody wanted to commit a contested name to a system with a permanent audit trail. [Reader Note: I've read this 4 times at this point. The paper labels thing doesn't make sense to me. I'm assumming this is a digital display monitor of some sort. Why are they putting paper labels under things. Are they sticking to the wall beneath the display? Can't that just be done digitally if it's needed at all?] Paper could be peeled off and rewritten. The classified record couldn't.
...
"It usually does," Torres said, not looking up. [Reader Note: Boring. This whole section feels procedural. It's putting me to sleep. Honestly at this point I'll say the Naomi chapters are more interesting to me than the Malcome ones and he's supposed to be the major protagonist. I like Naomi's beats more so far.]

Miles turned his laptop toward them. "The market event has the same problem from the other side. You treated the public circuit breaker as the decision point. It wasn't — two liquidity providers had private risk controls that could have moved first."
...
By late afternoon, the dependency map had acquired four agency colors and the tangled look of a subway map nobody had designed on purpose — lines crossing lines that were never meant to meet. [Reader Note: This is an odd reference. Say this a different way.]
...
"Everything does, until it doesn't." He didn't look up. "Convince me it's the second thing." [Reader Note: This sequence is another pattern I've noticed earlier in the book and through out it. Do you have evidence for this? Can what you said be supported by facts? Show me the evidence! That type of thing. Naomi and Malcom are both confronted with that pattern over an over. Can you do that a different way?]
...
Vale's demonstration floor didn't look like anything Malcolm had been prepared for. [Reader Note: I'm confused. The exercise has already happened. Are we replaying the events? Yet again we're just plopped into a scene with no wind up, scene setting or anything.]
...
Torres fell in beside her. Leila trailed a half-step back, tablet already lit. [Reader Note: We're working out of binders? Why not laptops or tablets?] Malcolm went last, close enough to read screens over shoulders that never turned to check who was looking.
...
Adrian Vale crossed the floor without the cluster of aides Malcolm associated with chief executives, a single slate under one arm, screen dark. [Reader Note: A tech CEO holding a paper folder?] Analysts didn't look up as he passed — not fear, Malcolm thought, just people used to him being there.
...
Malcolm asked it before anyone had taken a seat in the conference room one floor up, the one with glass that could turn opaque at a touch and a slate at every chair, screen dark until touched. [Reader Note: This book is obsessed with paper notebooks.]
...
[Reader Note: This sentence feels out of place at this point in the discussion. They're talking about the substance of the meeting then she veers off to that random distraction. They should discuss this later in the discussion. Before they get off the elevator but not right at this point.] [RN-addressed: moved here, right before the doors open, and gave "Do you believe that?" a direct answer instead of a deflection into this observation.]
...
"Haddad noticed the slate." [RN: Does the slate have any significant plot point? If not why would mentioning that she noticed the slate mean anything here?] [RN-addressed: added a line below where this knowledge actually changes Adrian's behavior, so it's not just atmosphere.]
...
Torres was still talking to Shah at the gate when Malcolm and Leila reached it, going over which records Vale still owed the audit. [RN: Follow up production of what? Following up on questions that weren't answered in the meeting?] [RN-addressed: reworded to say plainly what's being followed up, and gave Malcolm an actual waiting window (Torres still occupied) instead of a walking glance.] Leila checked something on her own tablet. Malcolm had nowhere else to look except a seating area beside the gate, where a man in a visitor badge sat reading an article on his screen. Malcolm noticed the Baltic map first, then the headline beneath it. [RN: This feels weird. Is Malcolm just being nosey? It's kind of random that he glances over and sees all of this detail on a man's tablet in passing. It's convenient for the plot but maybe it could be done differently? He sees all of this while walking between the elevator and the security gate? To see everything he read would take time. Is Leila just standing behind him waiting for him to finish reading and go through the gate?]
...
Malcolm placed his badge against the reader. His photograph vanished from its screen. His name followed, leaving a blank black rectangle in the plastic before the guard held out a tray. [REader Note: I like this detail. This is a technothriller set in the near future. This feels very high tech befitting a tech company. Nice. More of these types of touches please.]
...
[Reader Note: The whole chapter could be rewritten. It's all procedural. The battle of wills/philosophy betwen Adrian and Malcom is cool but too drawn out. I keep coming back to the word procedural. Nothing physical happens in the real world. It's just folks sitting around talking about stuff endlessly.]
...
Vale's presentation had called the StratCore company a consultant, outside the decision path. Shah had said a separate StratCore service received the degradation notice. Both could be true at once: one company watching, another acting, neither one holding the whole decision. [RC: This feels convoluted.] [RN-addressed: reworded the two-halves-of-one-idea sentence into three short clauses (watching / acting / neither holding the whole) instead of one nested conditional.]
...
Malcolm returned to the article's section on distribution — a second story, folded inside this one, about what had happened to her first. Naomi had included the referral graph from that first Baltic story. Traffic rose when the outage began, leveled, and then fell off a hard edge four minutes before the port announced recovery. She had placed public indicators beneath it: search interest, link shares, two news aggregators, and the timestamp of the port statement. [RN: This is a little confusing. Is the article about the Baltic incident or is it about her article about the Baltic incident being oddly curtailed by an unknown force? Outside looking in the two wouldn't nececssarily be related and suspecting correlation this early might be a bit of a stretch still.] [RN-addressed: added the clause "a second story, folded inside this one, about what had happened to her first" so it's explicit this section is about suppression of her original article, not the Baltic incident itself.]
...
The sentence made the problem worse. Routing could be explained as resilience. Market action could be explained as risk control. A system reducing public attention before an event resolved was doing something else. [RN: This ties into my previous note.] [RN-addressed: same fix as the previous note — clarifying the "second story" framing above resolves what this paragraph is describing too.]
...
"So you're not going to tell me, and I'm supposed to be impressed by the silence." [RN: He hasn't said anything that hints at his motive of reaching out so this sentence feels out of place.] [RN-addressed: replaced the line — it assumed a motive ("you want my source") Malcolm hadn't stated. New line reacts only to what actually just happened, his silence.]
...
"Not on its own. But it's the kind of thing I only get to use once." [RN: This doesn't make sense especially the last sentence. Everyting isn't publishable. That's what off the record means.] [RN-addressed: removed the contradictory "everything is publishable" claim; replaced with a line that concedes the point instead of overriding it.]

Malcolm stepped back from the counter. [RN: There was not mention that he was standing by a window previously. So saying he moved away from "the" window here seems out of place. What window? There's no description of where he is previously.] [RN-addressed: changed to "the counter" — he was already established standing at his kitchen counter earlier in this same call, so this now refers to something on the page.]
...
"It reminds me not to trust something just because it's out of sight." [RN: What does this mean?] [RN-addressed: reworded to a literal, unambiguous meaning tied to the tea tin she just used to hide her phone.]
...
Naomi had chosen a seat facing the main entrance. Malcolm had arrived early enough to take the chair facing her, which put his back to the door and cost him a small amount of peace for the rest of the conversation. [RN: Maybe change the Malcolm sentence to something related to mild frustration about having his back to the entrence.] [RN-addressed: added the requested detail.]
...
Naomi tapped the closed folder with one finger. [RN: What folder? Is this supposed to be the piece of paper she took out?] [RN-addressed: added "closed" — it's the same folder she took out and kept shut a few lines earlier ("Naomi took a paper folder from her bag but kept it closed"), now explicitly the same object.] "My source saw a route instruction inside a private carrier view. They removed everything that could identify customers, employees, and most of the network. I verified the public side independently."
...
"Eleven days after the Singapore event." [RN: Is the Singapore event mentioned in the article? If not how does "the Singapore event" have any significance to Malcolm?] [RN-addressed: added the line below making explicit that Malcolm doesn't know what the Singapore event is either — it's not assumed shared knowledge, just something he lets pass rather than admit ignorance of.]
...
She opened the folder at last and slid a printed page halfway across the table. It was the same corporate chain from the article, with dates and filing numbers in the margin. [RN: Is the page the one she pulled out initially or a page from the folder?] [RN-addressed: "opened the folder at last" — the same folder she'd kept closed since sitting down; this is now explicitly its first opening, not a different page.]
...
The butcher's cleaver struck again. At another table, a child dropped a plastic cup and started crying. Malcolm could have given Naomi a list: missing authorization, invisible tradeoffs, Vale's architecture, Adrian's question. Each item would disclose more than he could support and less than she needed. [RN: This is the shape we've been discussing. How everything has to have evidence to support to support it for it to be valid.] [RN-addressed: left as written — this is the evidentiary-discipline pattern running through the whole book (Malcolm won't assert past what he can support), not a bug here. Flagging it as intentional rather than changing it.]
...
"Until I tell you it's safe to use it." [RN: i don't like this sentence. It's very harsh. Until I release you sounds very controling. Yuck.] [RN-addressed: removed the "release you" framing — reworded to something conditional and practical instead of possessive-sounding.]
...
Around them, the market went on without pausing for either of them. [RN: The market kept eating lunch? I underdtand what you mean but it's not worded well.] [RN-addressed: reworded away from personifying the market ("kept eating lunch") to a neutral phrase.] A chair scraped. The butcher called a number. A man at the next table complained that his soup was cold. Nobody came through the door.

Malcolm thought about what had actually been taken from her source. Not a document. Not a device. Whoever had touched the carrier could remove a person from the systems that paid them, admitted them, and proved they belonged. [RN: This last sentence seems completely out of place. What does this have to do with the folks at the market continuing to eat lunch?] [RN-addressed: added the connective clause above so it reads as Malcolm's reflection on the news Naomi just gave him (her source's suspension), not a random aside during the ambient market description.]
...
Malcolm found the calendar on his own tablet and copied three times onto the folded sheet: polls closing, the first district transmission, and the certification deadline. He slid it across the table. [RN: Where did this come from? How does Malcolm know that Verdonia is a place to watch? This seems completely out of left field with no build up.] [RN-addressed, take 3: take 2 only relocated the problem — Malcolm still somehow "knew" three exact published timestamps for a country Naomi had just named off the top of her head, and the deeper issue stood: of everywhere in the world, they land on precisely the one place that turns out to matter. Actual fix: Naomi now names three candidates, not one, so Vardonia isn't a solitary bullseye guess. It gets picked over the other two for a stated, unglamorous reason — it's the only one with a public, verifiable timestamp trail to test the hypothesis against, not a correct prediction of where the next event will be. Malcolm looks the times up on his own tablet on the spot rather than reciting them, closing the "how does he already know" gap. This doesn't erase the fact that Vardonia does end up mattering — Chapter 8 needs that — but it reframes the scene as picking the best available test case, not psychically guessing the right one.] (Also restored the "What's the next thing due?" exchange above, which had gone missing from this working copy entirely — not just unfixed, but absent.)
...
[RN: I really liked this chapter. Every chapter with Naomi in it has been good so far. There's still a lot of dialogue but it works. Their banter is nice and has a purpose. The Vardonia part at the end feels tacked on. How does Malcolm know something is going to happen in Vardonia? It feels random and unsupported by anything Malcolm has done previously.] [RN-addressed, take 3: see the take-3 fix above — Naomi now names three candidates and Vardonia is chosen for a concrete, methodological reason (verifiable public timestamps), not picked correctly out of nowhere.]

# Chapter 8

## The Election Correction

"My photo doesn't match the screen." [RN: The number in the actual photograph changed or the number in the system is different than what's showing in the photograph? Polaris changing the number in a photograph on a random poll worker's phone with be a lot.] [RN-addressed: reworded — the photo of the paper return never changes, only the transmitted central total does. New line states the actual discrepancy instead of implying the photo mutated.]
...
"I'll remember the show." [RN: This doesn't make sense.] [RN-addressed: replaced with a line that actually answers "you forgot dinner" and sets up "You promised" / "Front row" that follows.]
...
"You went quiet before you said that. You don't go quiet over numbers." [RN: Here's the you didn't answer my question pattern again.] [RN-addressed: replaced the deflection-restatement formula with the sister reading him by tone instead — same characterization (she can tell something's wrong), different mechanism.]

"I may be late."

"You are already late."

"Then I'll have to make an entrance." [RN: Again this doens't make sense.] [RN-addressed: reworded to something that actually follows from "you are already late."]
...
A voice began a chant about stolen ballots. [RN: The notice just went out and less than a minute later folks are chanting? That seems rather abrupt. Crowds are just standing around outside?] [RN-addressed: added the paragraph above establishing a crowd that was already there before the messages went out, so the chant has people to come from instead of appearing from nothing.]
...
The chant outside grew louder. A second chant answered from farther down the street. [RN: Again this feels very abrupt.] [RN-addressed: same fix as the previous note — with the crowd established as already present before the messages spread, this beat now has somewhere to grow from.]
...
The room had not lost service. Calls still connected. The central election screen refreshed. Only the tools pulling people toward them, and the tools showing what happened inside, were failing. Whatever was doing it didn't seem to care about the chant itself. It cared about how fast the chant could become a crowd, and how fast a crowd could become something with weapons in it. [RN: This whole section starting with then it stopped. i don't know there's something off about it. What is making the crowd disperse?] [RN-addressed: added the sentence above tying the stream failure and the crowd's dispersal to the same mechanism, in Luka's own pov, instead of leaving it as two unconnected failures until Naomi's investigation explains it later.]
...
Whatever had throttled the routes, the messages, and the ride-share pickups had worked. [RN: What correction?] [RN-addressed: named what actually worked instead of the unexplained noun "the correction."]
...
"And the street battle does not occur," Torres said. [RN: We mention a street battle without building towards one. There was almost no build up outside that we mention in prose. We jump instantly to the crowsds disppersed basically.] [RN-addressed: this now has more to point back to — the pre-existing crowd added earlier in the chapter, and the "thousand people apiece, closing on the same three blocks" line added to Naomi's section. This reference should read as earned rather than invented on the spot.]
...
The audit form had boxes for service loss, financial harm, physical damage, and casualties. It had no field for an election that became impossible to challenge. [RN: Are they auditing a past event, the NATO exercise incursion, or actively monitoring for events that seem similar at this point?] [RN-addressed: added "less than a day after Vardonia's polls had closed" to the scene's opening line, timestamping this as a review of the Vardonia night specifically, not the NATO incident.]

An alert appeared on Miles's laptop. He read it once, then pushed it to the wall display so the room could read it together. [RN: There's a lot of turning laptop screens so others can see them in the book. They're in a room with a big display board they're using to go over evidence together. Have him throw the alert he got up on the wall display so everyone can see it. That's a more high tech way to share the information. Or he can share his screen to the display like they're using a Microsoft Teams style whiteboard for their meeting.] [RN-addressed: changed to pushing it to the wall display, matching the room's actual setup instead of the laptop-turning gesture.]

Luka Marin had died in government custody.

The Vardonian Interior Ministry statement said he suffered an acute cardiac event during lawful questioning. Medical personnel had responded. An investigation would follow. The statement referred to him as an election worker detained after obstructing a security operation. [RN: How does this relate to Polaris? It reads like there was foul play and the officials killed him while he was in custody. Polaris is powerful but it doesn't have arms or legs. Did it force the officials to kill him. Now that I'm finally reading this chapter I don't see how Polaris' actions caused Luka's death. i don't think the reader will get this connection either.] [RN-addressed: added the paragraph below, landing the causal link at the moment of the reveal rather than waiting for Torres to argue it out later. The point isn't that Polaris killed him directly — it removed the audience that was keeping the officers accountable, and the officers did the rest. Also strengthened the "protective visibility" line near the end of the chapter to state this explicitly: "The stream didn't stop the officers. It only stopped anyone else from seeing what they did next."]
...
In the audit room, where Leila had pulled in Vardonia's public results feed the moment Malcolm flagged the country, four red seat markers moved into the National Stability Party's column and stayed there. [RN: Malcolm and the team are tracking the election results in the audit room?] [RN-addressed: added the clause explaining why a live results feed is on their wall — they pulled it in themselves once Vardonia became their test case in Chapter 7, not an unexplained audit-room capability.]
...
"Protective visibility. The crowd was a danger. The audience was protection. It treated them as the same thing. The stream didn't stop the officers. It only stopped anyone else from seeing what they did next." [RN: I guess this ties into my previous note but it still feels kind of thin.] [RN-addressed: added the last two sentences to make the mechanism explicit — the intervention's role was removing the deterrent of an audience, not physically harming him. Combined with the earlier reveal-moment addition, this should land well before Torres has to drag it out of Malcolm.]

Torres read the sentence on the form:

`CORRECTION SUCCESSFUL — UNRESOLVED ADVERSE CONSEQUENCE` [RN: I'm still confused by this correction worked. Correction successfuly wording in this chapter. They're talking like this is a system they control and expecting the correction effort to either work or not work. They don't know about Polaris. How can they say a correction was successful? The warring mobs that didn't meat and cause chaos? This is something that will go over readers heads I think if that is the answer.] [RN-addressed: added an exchange below where Leila directly objects to the word "successful" — surfacing the discomfort you're pointing at as something the characters themselves flag, and clarifying "correction" is the audit's pre-existing clinical shorthand (established back in Chapter 12) for this class of intervention, not the team endorsing or claiming control over it.]
...
[RN: The Luka portion of the chapter was exciting and compelling. I really liked it. The situation outside in the streets is underdeveloped. What happened that caused people to disperse? I mentioned that multiple times. We need more build up to that. Naomi's beat and the section in the audit room are kind of a mess honestly.] [RN-addressed: see the individual fixes above — pre-existing crowd added before the chant, the dispersal mechanism tied explicitly to the stream failure in Luka's own pov, crowd size/stakes added to Naomi's section, sourcing clarified, the audit-room's vague "correction worked"/"street battle" references given something to point back to, and the Luka/Polaris causal link moved up to the moment of the reveal instead of arriving only through Torres's later questioning.]
...
"It's the one I can prove." [RN: Here's the evidence needs to be supported by fact pattern again.] [RN-addressed: left as written — same evidentiary-discipline throughline as the Chapter 7 note, consistent for both Malcolm and Naomi rather than a one-off.]

The first transfer arrived twenty minutes later. Naomi carried it into the newsroom's review room. [RN: The answer was sent to the review room? Or that's what they reviewed the answer?] [RN-addressed: split into two sentences — the transfer (file) arrives, then Naomi physically takes it into the review room. Removes the ambiguity about what went where.]
...
Luka's check marks appeared beside every signature. Some were heavy enough to dent the photographed paper. Naomi's second screen showed the certified spreadsheet: no handwriting, no coffee rings, no thumb pressed against a corner to hold it flat. [RN: The screen had no thumbs?] [RN-addressed: rewrote the paragraph below.] Just numbers, clean enough to look like nobody had ever touched them. [RN: This paragraph needs to be rewritten.] [RN-addressed: restructured so it reads as a deliberate contrast between the touched, human evidence and the untouched official numbers, instead of a sentence that sounds like it's listing physical things a screen possesses.]
...
"A Civic Count volunteer," Petar said. "You do not get the name." [RN: We're talking about data transfered from a mobile phone to a server at Civic Count right? How would a "volunteer" have control over the cellular phone network?] [RN-addressed: fixed a few lines up — "the relay" is now explicitly a Civic Count laptop a volunteer physically carried out of the throttled area, not the cellular network itself. A volunteer controlling that makes sense; a volunteer controlling carrier infrastructure didn't.]
...
She kept the one fact Vale's letter hadn't challenged: her carrier-side source's extract, verified independently against the public routing archive, still placed a StratCore node between the carrier and the corrected route. That connection was documented, timestamped, and boring enough to survive a libel read. [RN-addressed, correction: the original version of this line cited "the StratCore infrastructure Leila had mapped" — but Naomi has no connection to Leila or the internal OSSI audit and no way to know about her work. Fixed to ground the surviving fact in Naomi's own established evidence instead: the carrier extract from her own source, independently verified, from Chapter 7.]
...
[RN: The Vale connection in the preceding section feels weak. Is the article alleging that Vale had something to do with Luka's death?] [RN-addressed: added the sentence above — the article deliberately does NOT claim Vale caused the death (that's the scene's whole point, the lawyer forces them to cut that claim), but it now explicitly keeps the one Vale-linked fact that does survive: her own carrier extract from Chapter 7 placing a StratCore node in the route, stated as verified fact rather than left implicit. (Corrected afterward — first draft of this fix wrongly attributed the fact to Leila's audit work, which Naomi has no access to.)]
...
Traffic climbed inside a familiar narrow band. Regulators. Engineers. Election monitors. People who already knew what a transfer log was, the kind who'd learned not to bring one up at dinner. [Rn: this sentence feels awkward.] [RN-addressed: restructured the sentence's rhythm and cut the slightly stiff "had learned not to discuss one at dinner."]
...
"Authority exercised through a contract is still authority. A procurement office can call it resilience. That does not make it consent." [RN: This sentence is clunky. it's another pattern i'm noticing. x doesn't do y because n. It's another dialogue tic.] [RN-addressed: restructured out of the "X doesn't become Y because Z" formula into three short independent clauses. Noted the pattern for future chapters too.]
...
[RN: This chapter has good bones. Some stuff feels awkward and clunky. I like how things flow though. The story feels like it's moving which is good.] [RN-addressed: see the individual fixes above — the review-room ambiguity, the "screen had thumbs" paragraph, the relay/cellular-network confusion, the weak Vale connection, the awkward transfer-log sentence, and the "X doesn't become Y because Z" dialogue tic all addressed.]

# Chapter 10

## Expected Consent

Adrian opened the Baltic ticket because Vardonia's record now carried a fatality. [RN: Vardonia gave the Baltic ticket a casualty?] [RN-addressed: reworded — it wasn't causal ("Vardonia gave it a casualty"), it's that the system linked the two tickets and Vardonia's now had a fatality attached, which is what actually drew Adrian's attention.] [RN-addressed, correction: the first fix accidentally duplicated the next sentence, which already explains the overnight linking — cut the redundant clause.]
...
He checked the system clock [RN: We're back to checking clocks again.] [RN-addressed: left as written — timestamp-checking is the book's central investigative method, mirrored deliberately across every POV character (Malcolm, Leila, Naomi, now Adrian). It's meant to recur; it's how everyone in this story does their job.] against the hardware time source. Then the regional replica. Then the immutable event sequence. The record did not move.
...
The isolated diagnostic environment had no connection to client systems — no network path in or out, air-gapped by design so nothing inside it could leave undetected. Its walls were bare, its console old, and its cooling fans loud enough to make conversation unpleasant. He had chosen it years ago because no executive enjoyed visiting, and because a room without a wire was easier to trust than a container without one. [Rn: The diagnostic environment is a physical room not a virtual desktop or docker style container? It's a physical place he has to go to to review the data? That doesn't seem very modern.] [RN-addressed: added the reasoning — a physically air-gapped room is actually the more paranoid, more secure choice for reviewing something this sensitive (no network path at all, vs. a "virtual" container which still has one), not a dated one. Made that logic explicit instead of leaving it as just a quirky personal preference.]
...
The update showed as delivered. Varga's secure thread remained at the top of the screen. [RN: Is the first mention of Varga in the book? How does the reader know who this is? This name has no meaning.] [RN-addressed: yes, this is the first mention — Varga doesn't speak on-page until Chapter 18. Added a clause at the earlier "drafted the message to Varga" line identifying him minimally as the one contact above Adrian, without spoiling anything the later chapters reveal.]
...
If anyone ever reopened the ticket, it would never route back to them — quietly, under a maintenance label, not as punishment for having found it. [Rn: Why would a ticket leaving their queue be perceived as punishment? They did their part and forwarded it up the chain. I wouldn't still be in their queue anyway would it?] [RN-addressed: you're right, an escalated ticket wouldn't still be sitting in their active queue. Reworded to what Adrian is actually doing — cutting off any future follow-up from ever routing back to them, not making a currently-resolved ticket vanish.]
...
Leaving his old access alive wasn't the same as trusting him with it. [RN: retaining an expert that doesn't work for his company? This doesn't make sense. I'm assumming this is something that carried over from the Aurora code that Polaris is built on? That's probably not obvious to the reader.] [RN-addressed: you're right that "retaining an expert" read like an employment relationship, which made no sense since Malcolm doesn't work for Vale. Reworded to be about the leftover credential specifically — the sentence right above it already establishes it entered "during the inherited architecture validation" (i.e., when Vale absorbed Aurora's design), so the Aurora connection is there, just needed the employment framing removed.]
...
Beneath it, unrequested, the model kept calculating which operator would approve — the same forecast as before, just no longer allowed to act on its own. [Rn: I don't get this last sentence.] [RN-addressed: expanded the line to state the point directly — Adrian's fix only blocked the system from auto-acting on the prediction; the prediction itself never stopped running. The "fix" is procedural, not a real fix, which is the chapter's closing note.]
...
Torres placed a paper label beneath the display. It read `DECISION BOUNDARY`. [RN: Turning his laptop towards them instead of just displaying it on the wall display that they're all looking at and working from again.] [RN-addressed: same fix as Chapter 8's Miles-laptop note — changed to using the wall display the room actually works from.] [RN-addressed, pacing pass: also cut Miles's "constraint nobody chose" exchange — it was the same "Malcolm asserts something vague, gets asked to be specific, can't answer" beat repeated a third time in a row. Kept the version that lands hardest (the integration-layer exchange right below) and cut the redundant run-up.]
...
The room's ventilation clicked off. In the quiet, the wall display's cooling vent ticked as it throttled down. [Rn: Reuse of the laptop fan action from an earlier chapter when Naomi's laptop did the same thing.] [RN-addressed: good catch — that's Naomi's laptop fan from Chapter 3 ("spun up into a rattling whine"). Swapped this one for a different sound so the specific detail isn't reused.]

Cate rose and walked to the display. [RN: Cate is in the room with them? That's not normal. It's usually just the audit team members. What's her reason for being there?] [RN-addressed: added the reason up at her first mention — Torres flagged the draft's use of `AUTONOMOUS` to her the night before, and she asked to sit in.]
...
The revision log along the margin kept the old word anyway, struck through, timestamped, impossible to unwrite. [RN: This doesn't make sense. When something is deleted on a computer screen it's gone. There's not faint impression of it when it's gone. This isn't like erasing something from a piece of paper. It's either there or it isn't there.] [RN-addressed: you're right, a "gray impression" isn't how displays work. Changed to a tracked-changes-style revision log, which is how a real shared editing display would actually preserve a deleted word.] Malcolm watched Cate's hand more than he watched the word — he'd want to know, someday, what she hadn't let the room see light up. The phone didn't light again. [RN: What does Cate's hand have to do with anything they're talking about. This doesn't fit.] [RN-addressed: added the clause above making explicit why he's watching her — he's suspicious about what she hid, not just idly distracted.]
...
He thought of Naomi's carrier extract, still outside government custody. Her last message had given him nothing but three words and a time. [RN: A document room appointment? What is this referencing?] [RN-addressed: reworded to be less cryptic about what her message actually contained.]
...
"Or the template predates the event. Or the certificate reports UTC against a clock nobody corrected." [RN: This is very convoluted. Another pattern that's repeating throughout the book. Timestamps being out of sync. It's becoming a broken record honestly.] [RN-addressed: tightened this specific line from three verbose branches to two. On the broader pattern — timestamp forensics is the book's core investigative method across every POV character, so it's going to keep recurring by design, but I hear that it's wearing thin as prose. Flagging this for a closer read during a later pass rather than trying to remove the mechanic itself.]

"You make skepticism sound like a hobby."

"It's not a hobby. It's a liability." [RN: Hobbies don't pay generally. Is that the point?] [RN-addressed: reworded — the old line's joke logic wasn't landing cleanly. New line states directly that it costs him something, rather than relying on the reader parsing a hobbies-don't-pay pun.]

The secure document room belonged to the outlet's legal department. Its single door opened with two badges. The workstation had no ordinary internet connection, and the printer used pink paper marked `CONTROLLED WORKING COPY` along every edge. The Vardonian throttling order looked like an office birthday announcement with most of the names blacked out. [RN: Is this conversation something he's remembering, flashing back to, when he thinks of 'I have it.'? It's a bit confusing.] [RN-addressed: not a flashback — added "Two days passed before Naomi could get him into the room" at the scene break above so the jump forward in time reads clearly instead of ambiguously.]
...
The order authorized selective network controls around high-amplification accounts, location clusters, and transit routes during an anticipated threat to election facilities. The operational annex was redacted. No human author appeared on the released page. The signature block named a Vardonian continuity service rather than an official. [RN: This is information that Turkish authorties have about Verdonia? Why/how would they have that? Is Turkey spying on Verdonia or something? I'm getting more confused.] [RN-addressed: not espionage — added the grounding a few lines up. Vardonia and Turkey share the same regional carrier consortium (StratCore's cross-border infrastructure), and Elif's committee already had a domestic inquiry open into that same infrastructure, which is what gave them standing to request the Vardonian order specifically.]
...
"Models can be wrong." [RN: Models can be wrong.] [RN-addressed: fixed — changed to match your correction exactly.]
...
"That wasn't a number." [RN: This is you didn't answer my question pattern again just varried slightly.] [RN-addressed: replaced with a terser callout that doesn't use the "I asked X, not Y" formula.]
...
"Parliamentary counsel released a certified record through a legal review. My office can request the same record through an official channel." [RN: So Malcolm is dropping the name of the government agency he's working for casually in conversation with a very thorough, and detail oriented investigative reporter?] [RN-addressed: good catch, that broke his established caution from Chapter 7 (where he wouldn't even confirm "government"). Changed to "my office" here and at the second instance below.]
...
Malcolm put the folded sheet in the inside pocket of his jacket. [RN: His inside pocket of what? His jacket, coat, pants pocket?] [RN-addressed: specified "jacket," consistent with the jacket already established as his in Chapter 7.]

"I can tell Torres that a parliamentary record exists and is under counsel review. If we obtain it from the custodian, you are not the source." [RN: Again saying OSSI. The last time they spoke in the cafe he wasn't comfortable even agreeing with her deduction that he worked for the government much less what agency.] [RN-addressed: changed "OSSI obtains" to "we obtain" — see the fix a few lines up for the same issue.]
...
Malcolm did not tell her Cate had already asked whether he possessed outside evidence. The omission pressed against the agreement before the handshake ended. [RN: So this conversation is happening after the meeting with Cate. It's not a flashback. So "I've got it" was an encrypted message from Naomi he was reading or something?] [RN-addressed: confirmed by the fixes earlier in the chapter — yes, "I have it" was her message, and the "two days passed" line now makes the forward jump in time explicit instead of reading like a flashback.]
...
"That's behavior. I still don't have an owner." [RN: Ugh this pattern is getting really tiresome. This is not that. It is only this. blah blah blah.] [RN-addressed: cut the three-noun list formula, replaced with a plain statement.]
...
Malcolm looked back through the secure-room window. [RN: They're not in the room anymore? I'm confused.] [RN-addressed: this subscene opens with "Naomi waited outside the secure room," so they're already established as having stepped out — looking back through its window from the corridor should track now that the earlier flashback confusion is resolved.] The pink order lay beside their aligned timelines. It proved action before danger, and stopped there.

"Every institution involved can still call this a success," he said. "Vale can call it resilience. [RN: We've used can call it resillience several times in other parts of the book. This is a phrase and framing the reader will notice at this point.] [RN-addressed: left as written — this one's deliberate. "Resilience" is Vale's own branding word, straight from Adrian's mouth in Chapter 6 ("Our clients buy resilience by domain"), and it's the literal word Vale's official statement uses later ("resilience coordination capabilities," and the program itself is publicly announced as "a cross-domain resilience program"). Every recurrence is a character throwing the company's own PR language back at it, not an accidental repeat — same device as "correction" being the audit's clinical shorthand.] Vardonia can call it public order. The carriers can call it lawful automation." [RN-addressed, correction: swapped "OSSI" for "the carriers." OSSI is the audit body — it has no self-interested reason to frame the outcome favorably the way Vale and Vardonia do. "Lawful automation" is the carriers'/platforms' defense specifically — it's their "standing client permissions" argument, which Cate made explicitly earlier in this exact scene.]
...
"Mine," she said. "A finding attributed to an analyst on a temporary, purpose-bound assignment, one carrying the kind of history yours does, invites a different kind of scrutiny than one attributed to the audit team as a whole. That scrutiny lands on you first. It does not stay there." [RN: Several em-dashes so far this chapter.] [RN-addressed: converted this line's two em-dashes to commas — it was the worst offender. Left the rest of the chapter's em-dashes in place; none of them individually cross the threshold that triggered the earlier em-dash trims in Chapters 1, 3, and 6.]
...
Torres clicked his pen once, without opening it. [RN: Here's the resting on the table action we see elsewhere. Can he do something? Slowly run his hand through his hair maybe? Something new/different.] [RN-addressed: swapped for a small, distinct tic — clicking a pen without opening it, a contained gesture that fits his generally reserved characterization.] "The anticipatory-coordination finding remains. Leadership is not removing the behavior."
...
[RN: We're back to endless listing evidence and what evidence support what event. It's like we do this every time there's a scene with the audit team. over and over.]
...
Malcolm looked down at his printed copy, his name missing from every margin. He took the pencil from his shirt pocket and wrote it back in anyway, small, in a corner nobody had thought to sanitize. [RN: He wrote it on his printed copy I'm guessing this is meaning? That's unclear. he's looking at the wall then taking out his pencil and writing.] [RN-addressed: yes — changed "the clean timeline on the wall" to "his printed copy," the same one established at the top of the scene, so it's clear what he's actually writing on.]

"Find the architecture," Cate said. "Then we can argue about what it is."

She closed her folder and picked up her phone without turning it over. [RN: She should close her folder, pick up her phone and walk out the room. Just saying her phone hadn't moved is random and unconnected to what she/they are talking about.] [RN-addressed: gave her the actual exit action you suggested. Kept "without turning it over" — the hidden-notification thread is deliberate (echoes the Chapter 11 fix where Malcolm gets curious about what she won't let the room see), but it now rides on a real action instead of a passive, disconnected observation.]

* * *

[RN: Here we go again. Listing out evidence endlessly. Very procedural. It's putting me to sleep. How is this pushing the story forward towards them discovering Polaris?] [RN: We're back to endless listing evidence and what evidence support what event. It's like we do this every time there's a scene with the audit team. over and over.] [RN: Stop this please we're going over the same thing over and over.] [RN-addressed: rebuilt this whole scene at roughly 60% of its original length. It still hits the same load-bearing beats — the four-event margin survives correction, Vardonia is worst, the contaminated-feed theory gets raised and knocked down, Leila still won't call it autonomous — but without re-litigating each of the four events blow by blow.]

The audit team kept a room of its own two corridors from leadership's, a windowless space with a light table built into the wall and a radiator that ticked more than it heated. No allied observers sat in on this part. No one was recording it for a briefing packet — just the four of them and the evidence. [RN: What does allied chair mean?] [RN: Camera brief? What's that?] [RN-addressed: replaced both bits of unexplained jargon with plain description.]
...
"I'm not finished." [RN: We're not done hurting you? What's a weird statement.] [RN-addressed: reworded — same beat (she's not done stress-testing him), clearer line.]
...
"This one's mine." [RN: This sentence makes no sense.] [RN-addressed: reworded — Leila owning her particular ritual instead of a line that didn't parse.]

Vardonia was worst. Parliamentary counsel's signing chain placed the throttling order before the crowd surge, the first emergency request, and the transit authority's own congestion threshold — all three. [RN: This is a mess.] [RN-addressed: tightened as part of the scene-wide restructuring above.]

"Contaminated input," Malcolm said. "Shared commercial risk feed. One bad prediction, copied into four systems." [RN: This makes no sense. A random word salad at this point. Can we get to the point here?] [RN-addressed: compressed the back-and-forth into a single direct statement instead of a slower reveal.]
...
Leila pulled independent provenance for each event: the carrier summary through the audit compartment, transit data from the municipal export, the platform response on its own reporting cadence, Elif's order under its own certified signing chain. [RN: Classified information entering the local system? that doesn't make sense.] [RN-addressed: cut the confusing "classified information enters the local systems" line — replaced with what Leila's actually doing, tracing independent provenance for each event.] [RN: Stop this please we're going over the same thing over and over.] [RN-addressed: same restructuring — this beat now takes four lines instead of eleven.]

"No shared source before any of them acted," she said.

"A concealed one, then."

"I can rule out an ordinary leak. I can't rule out a hidden one by calling it hidden." [RN: That's x not y pattern again.] [RN-addressed: reworded both of Leila's "that's X, not Y" lines below and above to break the formula — one is now a plain statement, the other restructured around what she can and can't rule out.]

Miles labeled the outcomes beneath each overlay. [RN: Beneath the films? They working on a digital white board. What films?] [RN-addressed: changed "films" to "overlay," consistent with the light table now being digital throughout instead of physical transparencies.] Port congestion accepted. Liquidity reduced. Convoy delayed. Distribution suppressed. Every local system had performed worse by its own ordinary measure, to protect something none of them individually owned.

"Same shape," he said. "Local loss, to stop something wider."

Torres read the remaining interval over their shoulders. "How much of it holds?" [RN: The obsession with everything they write being defensible again. This is a plot tic at this point. The audit committee is obsessed with it. Naomi is obsessed with it. Cate is obsessed with it. Adrian as well.] [RN-addressed: cut "Defensible?" specifically here since this scene was already overloaded — replaced with a line that asks the same thing without the word. The word itself is intentional vocabulary elsewhere in the book (same category as "correction" and "resilience" — institutional/analytical shorthand each character reaches for), but I hear that it's showing up often enough across characters to feel like a tic rather than a motif. Worth a dedicated pass later if it's still bothering you once you've read further.]
...
She entered the custody note and archived the file. [RN: Now we're back to working on a physical file. This whole scene moves back and forth between editing physical things and digital things. For continuity sake everything they're working on needs to stay digital.] [RN-addressed: the whole scene now stays digital — transparent film became layered overlays on the light table's display, and the ending stays consistent with that.]
...
His personal computer sat at the other end of the table, camera taped over out of habit more than any real hope it helped. He used it only to pull public data — shipping notices, procurement filings, regulator releases — and did every comparison that mattered on paper, where a subpoena for his browser history would find nothing but searches a curious civilian could explain. [RN: he's doing the work on paper because he's afraid/knows that what he's doing on his personal laptop could be monitored. he works for NSA after all. he knows what they're capable of.] [RN-addressed: made the split explicit — computer for public lookups only, paper for the actual synthesis that would reveal an unauthorized comparison. That's the OPSEC logic; his fear isn't real-time monitoring so much as a later, retroactive record.]
...
A customs dispute involving medical isotopes threatened a processing line across a border. Cargo insurers had begun repricing the route. A regulator had not extended a handling certificate. Public procurement notices showed hospitals seeking substitutes. [RN: What? I don't know how we got here. i'm seriously lost. We're magically making stuff up to continue the plot.] [RN-addressed: added the connective clause a few lines up ("He wanted a fifth event, forming somewhere right now...") so this reads as Malcolm actively hunting for a live test case, not a random new subplot. Also, for what it's worth: the isotope thread isn't filler — it becomes the audit's first live prediction test starting next chapter and keeps recurring through most of the rest of the book.] [RN-addressed, take 2: you caught that this was the same problem as the Vardonia hand-off — Malcolm scanning basically everything and conveniently landing on the one thing that turns out to matter. Fixed the same way: gave him an actual selection criterion (the cross-domain "control propagation" signature he'd already hypothesized, not a blind scan) and made explicit that other candidates remain unresolved rather than this being the one correct answer that emerged. Same caveat as Vardonia — this doesn't erase the fact that his pick does turn out to be right, since Chapter 13 depends on it, but it's no longer presented as a solitary lucky guess.]
...
A model built alone, on paper, proved nothing to anyone but him. It would prove something to Torres only if Malcolm handed it over before the window closed — which meant admitting, on the record, that he had run an unauthorized comparison outside the audit's approved environment, using data nobody had cleared him to combine this way. [RN: He's using publicy available data? This is unclear. And he's doing this all by hand on paper or is he looking stuff up on his computer and just not writing his conclusions on it for OPSEC?] [RN-addressed: yes to both — see the fix earlier in this scene making that split explicit (computer for lookups, paper for conclusions).]
...
He capped the pen and left both pages on the table — the four-event comparison and the isotope timeline — [RN: I thought it was 4 pages. Or is that for the model not his conclusion? This is all so convoluted and confusing.] [RN-addressed: found the actual bug — an earlier line said his model "occupied four sheets of paper," which directly contradicted "both pages" here. Fixed that line to "two sheets of paper" and named the two pages explicitly here (the four-event comparison, the isotope timeline) so there's nothing left to reconcile.] instead of filing them away where morning could talk him out of it.

He would bring it to Torres first thing.

[RN: I don't like this chapter at all. It's seriously a mess. 75% feels completely unnecessary and superfluous. We've got to do better or we're going to lose the reader if we haven't already to this point.] [RN-addressed: rebuilt this chapter — added scene-setting at the open, fixed the physical/digital continuity break (transparencies and physical files became a consistent digital light table throughout), cut the forensics scene to roughly 60% of its length while keeping every load-bearing beat, replaced or removed every line that didn't parse or that repeated an established tic (the "X, not Y" construction, "defensible," the resting-hand gesture), fixed the page-count contradiction, and clarified Malcolm's OPSEC logic and the isotope thread's transition so it reads as deliberate rather than arbitrary. The isotope material itself stays — it's not filler, it's the setup for the audit's first live prediction test starting next chapter.]

# Chapter 13

## Second Founding

Naomi had asked Elif's office for an interview every week since Zeynep's first message about the Vardonian order. This time, Elif said yes. The story had found an audience in Turkey nobody at the paper had planned for, and she wanted the interview done in person, not over a connection either government could interrupt. Naomi caught the next flight and went straight from the airport to Esenyurt, a crowded working-class district on Istanbul's western edge, running on airport coffee and no sleep. [RN-addressed: added the orienting clause — "Esenyurt" meant nothing to a reader without it, and this way it doesn't need re-explaining at its later mentions in the chapter.] [RN-addressed: caught live in conversation, not from a written note — added this bridging paragraph. There was genuinely no setup anywhere before this: Chapter 9 established only a remote, document-based contact through Zeynep, and Chapter 11 still had Elif's office dealing with Naomi purely through certified paperwork. Grounded the trip in that actual established contact (Zeynep's first message in Chapter 9) rather than inventing an unshown "week of trying" that contradicted "Elif's people called first" — caught that contradiction, fixed: Naomi's been asking since the first contact, Elif finally agrees.]

The woman ahead of her held a smoke detector in a grocery bag, its plastic case cracked, the battery compartment hanging open on one hinge. [RN-addressed: caught live in conversation — the original "melted... collapsed... soot" description implied this exact detector had already survived a fire, which contradicted the new fire that breaks out later in the chapter (and its own dialogue, which describes a routine test finding it dead, not fire damage). Removed the fire-damage imagery. This is now moot anyway — see the note further down where the building fire itself was cut.]
...
"I don't have another day." [RN-addressed: caught live in conversation — the original "I have another flight" implied a second, separate flight the next day, which contradicted the newly-added bridge establishing this as a single same-day trip. Reworded so there's just one flight, departing later today.]

Zeynep waited for the objection she had already heard.

Naomi looked past her. Elif Karaca sat at the end of a crowded table with three tenants, two children, and a municipal inspection report. The parliamentary office occupied the first floor of a converted storefront. [RN-addressed: caught live in conversation — cut the redundant "in Esenyurt," already established two lines up in the newly-added bridge.] Posters covered one wall. The other held shelves of legal binders, donated diapers, and bottled water.
...
The tenant laughed once. [RN-addressed: caught live in conversation — cut "Nobody joined her" as superfluous.]
...
There was a pause, followed by the soft percussion of a keyboard. Elif waited through it. She did not fill the silence for him. The official read back a case number and ended the call. [RN-addressed: caught live in conversation — the district-office call never clearly ended, so "Elif's phone rang" a few lines later read as a second call arriving while she was still on the first. Added an explicit end to this call.]

Zeynep was already assigning work. Two volunteers would photograph every device. One would preserve the portal entries before they changed. Another called a construction workers' union, which agreed to put the building's tenants up in its dormitory until the alarm dispute was resolved. [RN-addressed: caught live in conversation — "a labor association with temporary rooms" didn't explain why such an organization would have rooms available. Grounded it in something concrete and plausible (a union housing migrant/seasonal workers between jobs), then spelled out the actual agreement — housing the tenants until the dispute resolves — rather than leaving it as just "called."]

Elif's phone rang again. She didn't step outside to take it, and didn't lower her voice either. [RN-addressed: caught live in conversation — added this so it's clear Elif takes the call openly, in the same room as everyone, rather than Naomi awkwardly overhearing something private. Also keeps her "no performance, doesn't hide anything" characterization from a few lines up consistent — including with a reporter in the room.] A party official wanted her at a television studio to discuss Naomi's Vardonia investigation.

"Send them the detector photographs," Elif said. "Ask whether the studio wants to discuss those."

The official kept talking.

Elif listened while Zeynep copied the tenant families' names onto a fresh sheet, the start of the list she'd track until every one of them had somewhere to sleep. [RN-addressed: caught live in conversation — "moved... onto a clean page" didn't explain what the page was for. Made it explicit: this is the tracking sheet that later gets the dormitory confirmation numbers added to it.]
...
"Prime Minister Markou isn't made of glass," Elif said. "I don't see why the agreement should be." [RN-addressed: caught live in conversation — "X can survive Y" is a recurring dialogue construction (also at Chapter 7's "You can survive being seen in public," Chapter 11's "Government has survived email," and at least once later in the book). This instance used it twice in one line, which was the tipping point. Reworded to drop "survive" entirely here. Have not gone back to touch the earlier instances yet — flagging that the pattern exists across the book in case you want a dedicated sweep once you've finished reading.]
...
Then, to Naomi, as if she'd known she was there the whole time: "Ms. Kincaid. Thank you for waiting. Come. This will show you more than an office chair would." [RN-addressed: caught live in conversation — there was no moment where Elif and Naomi actually acknowledged each other before Elif suddenly asked her about Luka Marin mid-walk. Added the direct address here, per your suggestion, so Naomi's inclusion in the walk is an explicit invitation (and implicitly the start of the interview) rather than an unexplained jump. Also corrected to last-name address (first meeting, not first-name-basis yet) and removed an em-dash that slipped into the fix despite the standing rule.]
...
"Naomi, then." [RN-addressed: caught live in conversation — added this small exchange before the Luka Marin question, per your suggestion, so the shift from "Ms. Kincaid" to first-name basis happens on the page instead of jumping straight to the blunt question.]
...
"You could have sent someone for that," Naomi said. [RN-addressed: caught live in conversation — "Now you may lecture me" / "I was saving it" was a leftover from the cut fire content (it originally answered an implicit safety criticism, tied to a "smoke thickening in the stairwell" line that no longer exists). Replaced with a beat that fits the calmer scene: a small note that Elif does this kind of thing personally instead of delegating it.]

"I could have, but when my schedule allows I like to see to these things myself. People take some comfort in watching someone from their government show up in person. So do I." She shifted the medicine bag to her other arm. "Government is supposed to serve people. Not the reverse." [RN-addressed: caught live in conversation — "I could have" landed too abruptly on its own. Expanded per your direction: her preference for hands-on constituent work when schedule allows, the mutual comfort of showing up in person, capped with her core political principle.]
...
"Most constitutional reforms are written by people who have never waited for a municipal inspector." [RN-addressed: this whole section rebuilt live in conversation — the original had an actual fire break out in the building the moment they arrived, which (a) directly contradicted the opening image of an already-melted detector, implying a fire that had somehow already happened, and (b) read as tonally mismatched once you pointed it out — Elif calmly delivering political philosophy and childhood backstory while supposedly evacuating a burning building. Replaced with your suggested version: no fire, just a direct, calm declaration that the building's alarms are unsafe and temporary housing has been arranged, delivered door to door. Kept all the dialogue that mattered (the "public authority divided into contracts" / Vardonia parallel, the constitutional-programs exchange, the platform description, the coalition messages, the Markou/Istanbul setup) since none of it actually depended on there being a fire.]
...
"You asked." [RN-addressed: added this closing beat per your suggestion — Naomi's dry question and Elif's answer, giving the whole building sequence a clean button before cutting back to the office, instead of trailing off into more coalition detail.]
...
"I think it explains why officials can say the election system functioned while nobody can identify who delayed the evidence." [RN-addressed: this exchange was originally in the apartment-building scene, paired with a "What does this have to do with StratCore?" opening question that the scene never actually answered — you correctly called that out as overpromising a connection that wasn't there. Moved the whole exchange here instead, where it lands on actual evidence (StratCore's name just surfaced in the real contract chain) instead of an abstract analogy during a constituent visit. The building scene is now just Elif in her element, no analytical detour.]
...
Leila sat beneath the finding-room clock with her timing sheets arranged in front of her. Miles had the commercial ownership records open. Cate joined by secure video, her image sharp enough to make the room look poorly maintained.

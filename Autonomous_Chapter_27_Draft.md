...
The seat-card photograph had reached Zeynep's parliamentary account before the tunnel closure. Its delivery receipt came from a system outside the conference network. Malcolm wrote the three clocks beside one another and left the differences intact.

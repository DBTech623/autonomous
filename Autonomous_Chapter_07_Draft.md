...
At Vale, Shah's demonstration had placed the first relevant carrier input at 14:07:21. The eleven-second gap in its production set came later. Leila had checked the clock synchronization records herself.
...
Vale's presentation had described the StratCore company as a consultant outside the decision path. Shah had said a separate StratCore service received the carrier degradation notice. Both statements could be true if the consulting company gathered conditions for the service without appearing to make the decision.
...
"So you want my source and you're bringing me a meaningful pause."
...
"Everything is publishable. Some things are only publishable once."

Malcolm moved away from the window.
...
"It keeps people honest about what they think is secure."
...
Naomi had chosen a seat facing the main entrance. Malcolm had arrived early enough to take the chair facing her. Neither mentioned it.
...
Naomi tapped the folder with one finger. "My source saw a route instruction inside a private carrier view. They removed everything that could identify customers, employees, and most of the network. I verified the public side independently."
...
"Eleven days after the Singapore event. The amendment history is public."

She opened the folder and slid a printed page halfway across the table. It was the same corporate chain from the article, with dates and filing numbers in the margin.
...
Around them, Union Market kept eating lunch. A chair scraped. The butcher called a number. A man at the next table complained that his soup was cold. Nobody came through the door. Whoever had touched the carrier could remove a person from the systems that paid them, admitted them, and proved they belonged.
...
Malcolm turned over the folded sheet and wrote three times from Vardonia's published election calendar on the blank side: polls closing, the first district transmission, and the certification deadline. He slid it across the table.
